    ...
    <div className="container inset-0 mx-auto px-2 py-8 lg:px-12 lg:py-4 rounded text-center overflow-hidden">
      ...
      <div className="flex justify-center mb-5 px-4">
        <div className="w-full md:w-2/5 flex mb-5">
          ...
          <button
            type="button"
            className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 font-bold rounded-lg text-md py-3 px-4 text-center"
          >
            Subscribe
          </button>
        </div>
        ...
        <div className="container inset-0 mx-auto px-2 py-8 lg:px-12 lg:py-4">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-white uppercase ">Link</h2>
              ...
              <div>
                ...
                <ul className="text-gray-500  font-medium">
                  <li className="mb-4">
                    <Link href="https://www.instagram.com/blue_star_motors/?igshid=MzRlODBiNWFlZA%3D"  target='_blank'
                  ...
                  <li>
                    <Link href="https://www.facebook.com/people/Mudassar-Shaikh/100083367522006/?mibextid=ZbWKwL" target='_blank'
         ...
         <div className="container inset-0 mx-auto px-2 py-8 lg:px-12 lg:py-4 rounded text-center overflow-hidden ">
          ...
          <div className="sm:flex sm:items-center sm:justify-between mb-4">
            <span className="text-sm text-gray-500 sm:text-center ">© 2024 <Link href="#" className="hover:underline">qurbani.com </Link>. All Rights Reserved.
            </span>
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <Link href="https://www.facebook.com/people/Mudassar-Shaikh/100083367522006/?mibextid=ZbWKwL" target='_blank' className="text-gray-500 hover:text-gray-900 ">
