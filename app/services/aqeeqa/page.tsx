    ...
    <div className="flex flex-col md:flex-row justify-between gap-8 max-w-8xl mx-4">
      ...
      <div className="w-full md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="text-center">
          <button type="button" className="text-white bg-gradient-to-br text-lg font-bold w-full md:w-80 py-3 me-2 mb-2 from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 rounded-lg">
